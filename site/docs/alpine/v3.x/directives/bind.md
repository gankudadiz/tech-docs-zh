---
title: x-bind
source: https://github.com/alpinejs/alpine/blob/main/packages/docs/src/en/directives/bind.md
source_version: v3.x
...
> 尽管未包含在上面的代码片段中，但如果没有任何父元素定义 `x-data`，则不能使用 `x-bind`。[→ 阅读更多关于 `x-data` 的内容](./data)
