---
title: 安装
source: https://github.com/alpinejs/alpine/blob/main/packages/docs/src/en/essentials/installation.md
source_version: v3.x
...
请注意你仍然需要用 `x-data` 定义一个组件，Alpine.js 的属性才能生效。更多信息请参见 [alpinejs/alpine discussions/3805](https://github.com/alpinejs/alpine/discussions/3805)。
