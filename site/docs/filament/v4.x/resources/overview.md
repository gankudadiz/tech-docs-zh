...
![A resource listing page](/assets/filament/v4.x/screenshots/images/light/panels/resources/listing.jpg)
...
![Simple (modal) resource create modal](/assets/filament/v4.x/screenshots/images/light/panels/resources/simple-modal-create.jpg)

![Simple (modal) resource edit modal](/assets/filament/v4.x/screenshots/images/light/panels/resources/simple-modal-edit.jpg)
...
![Resource with sub-navigation](/assets/filament/v4.x/screenshots/images/light/panels/resources/sub-navigation.jpg)
...
![Resource with end sub-navigation position](/assets/filament/v4.x/screenshots/images/light/panels/resources/sub-navigation-end.jpg)

The `SubNavigationPosition::Top` option renders the sub-navigation as tabs above the page content:

![Resource with top sub-navigation position](/assets/filament/v4.x/screenshots/images/light/panels/resources/sub-navigation-top.jpg)
