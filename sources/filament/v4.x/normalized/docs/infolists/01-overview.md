...
![Product infolist example](/assets/filament/v4.x/screenshots/images/light/infolists/overview.jpg)
...
![Entries in an infolist](/assets/filament/v4.x/screenshots/images/light/infolists/entries/simple.jpg)
...
![Entry with a placeholder for empty state](/assets/filament/v4.x/screenshots/images/light/infolists/entries/placeholder.jpg)
...
![Entry with a hidden label](/assets/filament/v4.x/screenshots/images/light/infolists/entries/hidden-label.jpg)
...
The function passed to `url()` can inject various utilities as parameters.
...
As well as allowing a static value, the `openUrlInNewTab()` method also accepts a function to dynamically calculate it. You can inject various utilities into the function as parameters.
...
![Infolist entry with inline label](/assets/filament/v4.x/screenshots/images/light/infolists/entries/inline-label.jpg)
...
![Infolist entries with inline labels in a section](/assets/filament/v4.x/screenshots/images/light/infolists/entries/inline-label/section.jpg)
...
![Entry with tooltip](/assets/filament/v4.x/screenshots/images/light/infolists/entries/tooltips.jpg)
...
![Entries with different alignments](/assets/filament/v4.x/screenshots/images/light/infolists/entries/alignment.jpg)
...
![Infolist entry with text below content](/assets/filament/v4.x/screenshots/images/light/infolists/entries/below-content/text.jpg)
...
![Infolist entry with component below content](/assets/filament/v4.x/screenshots/images/light/infolists/entries/below-content/component.jpg)
...
![Infolist entry with action below content](/assets/filament/v4.x/screenshots/images/light/infolists/entries/below-content/action.jpg)
...
![Infolist entry with multiple components below content](/assets/filament/v4.x/screenshots/images/light/infolists/entries/below-content.jpg)
...
![Infolist entry with aligned components below content](/assets/filament/v4.x/screenshots/images/light/infolists/entries/below-content/alignment.jpg)
...
![Infolist entry with extra content above label](/assets/filament/v4.x/screenshots/images/light/infolists/entries/above-label.jpg)
...
![Infolist entry with extra content before label](/assets/filament/v4.x/screenshots/images/light/infolists/entries/before-label.jpg)
...
![Infolist entry with extra content after label](/assets/filament/v4.x/screenshots/images/light/infolists/entries/after-label.jpg)
...
![Infolist entry with extra content after label aligned to the start](/assets/filament/v4.x/screenshots/images/light/infolists/entries/after-label/aligned-start.jpg)
...
![Infolist entry with extra content below label](/assets/filament/v4.x/screenshots/images/light/infolists/entries/below-label.jpg)
...
![Infolist entry with extra content above content](/assets/filament/v4.x/screenshots/images/light/infolists/entries/above-content.jpg)
...
![Infolist entry with extra content before content](/assets/filament/v4.x/screenshots/images/light/infolists/entries/before-content.jpg)
...
![Infolist entry with extra content after content](/assets/filament/v4.x/screenshots/images/light/infolists/entries/after-content.jpg)
...
As well as allowing a static value, the `extraEntryWrapperAttributes()` method also accepts a function to dynamically calculate it. You can inject various utilities into the function as parameters.
