...
![Relation manager](../../../raw-assets/docs-assets/screenshots/images/light/panels/resources/relation-manager.jpg)
...
![Relation manager attach modal](../../../raw-assets/docs-assets/screenshots/images/light/panels/resources/relation-manager-attach.jpg)
...
![Relation managers with grouped tabs](../../../raw-assets/docs-assets/screenshots/images/light/panels/resources/relation-manager-grouped.jpg)
...
![Resource edit page with combined relation manager tabs](../../../raw-assets/docs-assets/screenshots/images/light/panels/resources/editing-combined-tabs.jpg)
...
As well as allowing static values, the `badgeColor()` and `badgeTooltip()` methods also accept functions to dynamically calculate them. You can inject various utilities into the functions as parameters.
